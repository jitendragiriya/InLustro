      ...
      <header className="w-full h-14 flex items-center justify-between border-b border-bgray-300 sticky top-0 z-[1001] bg-[#f7f7f7] px-4">
        ...
        <div className="flex items-center">
          <button className="mx-1 p-1 text-xl relative">
            <MdOutlineEmail />
            <span className="absolute -top-1 right-0 text-xs h-4 w-4 rounded-full bg-blue-400 text-white font-semibold flex items-center justify-center">3</span>
          </button>
          <button className="mx-1 p-1 text-xl">
            <IoMdNotificationsOutline />
          </button>
          <button className="ml-1 h-8 w-8 rounded-full bg-gray-400"></button>
        </div>
      </header>
    </>
  );
